...
export default function Animation() {
  ...
  const API_URL = `https://api.themoviedb.org/3/discover/movie?api_key=f8aa98bfbb1c2940f9b235241e070eee&language=fr_fr&sort_by=release_date.desc&page=${moviePage}&with_genres=16`;
  ...
  return (
    <div>
      ...
      <div className="movie_container">
        ...
        <h2 className="movie_introduce">Films d'animations :</h2>
